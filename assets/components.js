    ...
    footer.innerHTML = `
      <div class="footer-inner">
        ...
        <div class="footer-col">
          <h4>Community</h4>
          <ul>
            <li><a href="https://discord.gg/skyfrost" target="_blank">Discord</a></li>
      ...
      <div class="footer-bottom" style="margin-top:2rem;padding-top:1.5rem;border-top:1px solid var(--border);max-width:1200px;margin-left:auto;margin-right:auto;display:flex;align-items:center;justify-content:space-between;">
        ...
        <div class="footer-social">
          <a href="https://discord.gg/skyfrost" target="_blank" title="Discord">
          ...
          <a href="https://store.skyfrost.it" target="_blank" title="Store">🛒</a>
        </div>
      </div>
    `;
