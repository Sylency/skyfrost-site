(function () {
  ...
  Object.assign(EXTRA_DICTIONARY.it, {
    ...
    meta_cookie_desc: 'Informazioni sui cookie tecnici e sugli strumenti di misurazione con consenso usati da SkyFrost Network.',
    ...
    footer_cookie_manage: 'Gestisci preferenze cookie',
    ...
    mc_hero_players_label: 'su',
    mc_section_eyebrow: 'Minecraft Live',
    mc_section_title: 'Survival & Skyblock',
    mc_section_desc: "Due modalita, un solo hub e un'identita precisa: progressione costante, economia pulita e sessioni che restano memorabili.",
    mc_loading_badge: 'Connessione...',
    mc_badge_online: 'Online ora',
    mc_badge_offline: 'Offline',
    mc_badge_unavailable: 'Dato non disponibile',
    mc_kpi_players: 'Giocatori',
    mc_kpi_version: 'Versione',
    mc_kpi_version_sub: 'Compatibile con le versioni recenti',
    mc_kpi_software: 'Software',
    mc_kpi_software_sub: 'Stack del server',
    mc_kpi_plugins: 'Plugin',
    mc_kpi_plugins_sub: 'Moduli rilevati',
    mc_mode_survival_title: 'Survival',
    mc_mode_survival_desc: 'Economia bilanciata, progressione chiara e loop di gioco pensato per rimanere fresco anche nel lungo periodo.',
    mc_mode_skyblock_title: 'Skyblock',
    mc_mode_skyblock_desc: 'Isole che crescono davvero, obiettivi continui e una progressione che premia creativita e costanza.',
    mc_copy_cta: 'Copia IP Minecraft',
    mc_wiki_cta: 'Apri la Wiki',
    mc_panel_label: 'Server Snapshot',
    mc_panel_title: 'Segnale in tempo reale',
    mc_motd_label: 'MOTD',
    mc_loading_motd: 'Sto leggendo il messaggio live del server...',
    mc_meta_address: 'Indirizzo',
    mc_meta_srv: 'SRV',
    mc_meta_updated: 'Aggiornato',
    mc_players_label: 'Giocatori visibili',
    mc_players_waiting: 'In attesa dei dati live',
    mc_players_none_visible: 'Nessun nome esposto dal provider',
    mc_players_offline: 'Server offline al momento',
    mc_hero_online_players: '{count} online',
    mc_hero_online_generic: 'Online ora',
    mc_hero_offline: 'Offline',
    mc_hero_unavailable: 'Stato non disponibile',
    mc_player_cap: '/ {count} max',
    mc_player_cap_unknown: '/ -- max',
    mc_unknown_version: 'Rilevamento...',
    mc_unknown_software: 'Auto',
    mc_query_unavailable: 'N/D',
    mc_motd_offline: 'Il server e offline in questo momento, ma la base e pronta per tornare live.',
    mc_motd_unavailable: 'Il feed live non e raggiungibile al momento. Riprova tra poco.',
    mc_direct_connection: 'Connessione diretta',
    vote_rewards_desc: 'Le ricompense cambiano in base alla piattaforma: su Minecraft ricevi 5 Gems in tutte le modalita, su Hytale 1000 monete + 2 Vote Key.',
    vote_reward_coins: 'Monete',
    vote_reward_key: 'Vote Key',
    vote_reward_line: '🎁 1000 monete + 2 Vote Key',
    vote_reward_mc_title: 'Minecraft',
    vote_reward_hytale_title: 'Hytale',
    vote_reward_mc_line: '🎁 5 Gems in tutte le modalita',
    vote_reward_hytale_line: '🎁 1000 monete + 2 Vote Key',
    vote_group_minecraft_desc: 'I 5 siti Minecraft restano sulla stessa riga: scorri lateralmente per vederli tutti.',
    ...
    vote_site_mc_3_desc: 'Directory globale per server Minecraft: un voto in più per aumentare la visibilita di SkyFrost.',
    vote_site_mc_4_desc: 'Portale dedicato alle classifiche Minecraft: il tuo voto giornaliero aiuta SkyFrost a salire ancora.',
    vote_site_mc_5_desc: 'Portale italiano dedicato ai server Minecraft: un altro voto giornaliero per far crescere la presenza di SkyFrost.',
    ...
    wiki_connection_ip: 'IP server: <code>play.skyfrost.eu</code>',
    ...
    legal_updated: 'Ultimo aggiornamento: 15 aprile 2026.',
    ...
    cookie_item_3: '<code>sf_cookie_consent</code>: memorizza la tua scelta sul banner cookie nel browser.',
    cookie_section_2_desc: 'Questi strumenti sono tecnici o funzionali alla gestione del consenso e servono a mantenere login, sicurezza OAuth e preferenze privacy.',
    cookie_section_3_title: 'Misurazione e servizi di terze parti',
    cookie_section_3_desc: 'SkyFrost usa il Google tag per misurare visite e conversioni solo dopo consenso esplicito. Restano inoltre presenti integrazioni esterne come Discord e Tebex, soggette alle rispettive policy quando visiti i loro domini.',
    cookie_section_4_title: 'Gestione e revoca del consenso',
    cookie_section_4_desc: 'Puoi accettare o rifiutare i cookie di misurazione dal banner e riaprire le preferenze dal footer del sito. Puoi anche cancellare i cookie dal browser; disabilitare quelli tecnici puo impedire login Discord e invio ticket.',
  ...
  Object.assign(EXTRA_DICTIONARY.en, {
    ...
    meta_cookie_title: 'Cookie Policy — SkyFrost Network',
    meta_cookie_desc: 'Information about the technical cookies and consent-based measurement tools used by the SkyFrost Network website.',
    ...
    footer_privacy_link: 'Privacy Policy',
    footer_cookie_link: 'Cookie Policy',
    footer_cookie_manage: 'Manage cookie preferences',
    ...
    mc_hero_players_label: 'on',
    mc_section_eyebrow: 'Minecraft Live',
    mc_section_title: 'Survival & Skyblock',
    mc_section_desc: 'Two modes, one hub, and a sharp identity: steady progression, clean economy, and sessions worth remembering.',
    mc_loading_badge: 'Connecting...',
    mc_badge_online: 'Online now',
    mc_badge_offline: 'Offline',
    mc_badge_unavailable: 'Data unavailable',
    mc_kpi_players: 'Players',
    mc_kpi_version: 'Version',
    mc_kpi_version_sub: 'Compatible with recent versions',
    mc_kpi_software: 'Software',
    mc_kpi_software_sub: 'Server stack',
    mc_kpi_plugins: 'Plugins',
    mc_kpi_plugins_sub: 'Detected modules',
    mc_mode_survival_title: 'Survival',
    mc_mode_survival_desc: 'Balanced economy, readable progression, and a gameplay loop built to stay fresh over time.',
    mc_mode_skyblock_title: 'Skyblock',
    mc_mode_skyblock_desc: 'Islands that really grow, constant goals, and progression that rewards creativity and consistency.',
    mc_copy_cta: 'Copy Minecraft IP',
    mc_wiki_cta: 'Open the Wiki',
    mc_panel_label: 'Server Snapshot',
    mc_panel_title: 'Live signal',
    mc_motd_label: 'MOTD',
    mc_loading_motd: 'Reading the live server message...',
    mc_meta_address: 'Address',
    mc_meta_srv: 'SRV',
    mc_meta_updated: 'Updated',
    mc_players_label: 'Visible players',
    mc_players_waiting: 'Waiting for live data',
    mc_players_none_visible: 'No names exposed by the provider',
    mc_players_offline: 'Server currently offline',
    mc_hero_online_players: '{count} online',
    mc_hero_online_generic: 'Online now',
    mc_hero_offline: 'Offline',
    mc_hero_unavailable: 'Status unavailable',
    mc_player_cap: '/ {count} max',
    mc_player_cap_unknown: '/ -- max',
    mc_unknown_version: 'Detecting...',
    mc_unknown_software: 'Auto',
    mc_query_unavailable: 'N/A',
    mc_motd_offline: 'The server is offline right now, but the core is ready to come back live.',
    mc_motd_unavailable: 'The live feed is unreachable right now. Please try again soon.',
    mc_direct_connection: 'Direct connection',
    vote_rewards_desc: 'Rewards change depending on the platform: Minecraft gives 5 Gems in every mode, while Hytale gives 1000 coins + 2 Vote Keys.',
    vote_reward_coins: 'Coins',
    vote_reward_key: 'Vote Key',
    vote_reward_line: '🎁 1000 coins + 2 Vote Keys',
    vote_reward_mc_title: 'Minecraft',
    vote_reward_hytale_title: 'Hytale',
    vote_reward_mc_line: '🎁 5 Gems in every mode',
    vote_reward_hytale_line: '🎁 1000 coins + 2 Vote Keys',
    vote_group_minecraft_desc: 'All 5 Minecraft sites stay on the same row: scroll sideways to view them all.',
    ...
    vote_site_mc_3_desc: 'Global Minecraft directory: one more vote to increase SkyFrost visibility.',
    vote_site_mc_4_desc: 'Minecraft ranking portal: your daily vote helps SkyFrost climb even higher.',
    vote_site_mc_5_desc: 'Italian Minecraft portal: one more daily vote to grow SkyFrost visibility.',
    ...
    wiki_connection_ip: 'Server IP: <code>play.skyfrost.eu</code>',
    ...
    legal_updated: 'Last updated: April 15, 2026.',
    privacy_title_plain: 'Privacy',
    privacy_title_glow: 'Policy',
    ...
    cookie_item_3: '<code>sf_cookie_consent</code>: stores your cookie banner choice in the browser.',
    cookie_section_2_desc: 'These tools are technical or required to manage consent, and keep login, OAuth security, and privacy preferences working correctly.',
    cookie_section_3_title: 'Measurement and Third-Party Services',
    cookie_section_3_desc: 'SkyFrost uses the Google tag to measure visits and conversions only after explicit consent. External services such as Discord and Tebex are also present and remain subject to their own policies when you visit their domains.',
    cookie_section_4_title: 'Management and Consent Withdrawal',
    cookie_section_4_desc: 'You can accept or reject measurement cookies from the banner and reopen your preferences from the site footer. You can also delete cookies from your browser; disabling technical cookies may prevent Discord login and ticket submission.',
    terms_eyebrow: 'Rules',
